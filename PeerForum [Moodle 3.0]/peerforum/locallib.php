...
class peerforum_portfolio_caller extends portfolio_module_caller_base {
    ...
    public function load_data() {
        ...
        if ($this->post) {
            if ($this->attachment) {
                ...
                $attach = $fs->get_area_files($this->modcontext->id, 'mod_peerforum', 'attachment', $this->post->id, 'timemodified', false);
                $embed  = $fs->get_area_files($this->modcontext->id, 'mod_peerforum', 'post', $this->post->id, 'timemodified', false);
            ...
            foreach ($this->posts as $post) {
                $attach = $fs->get_area_files($this->modcontext->id, 'mod_peerforum', 'attachment', $post->id, 'timemodified', false);
    ...
    private function prepare_post($post, $fileoutputextras=null) {
        ...
        $formattedtext = portfolio_rewrite_pluginfile_urls($formattedtext, $this->modcontext->id, 'mod_peerforum', 'post', $post->id, $format);
