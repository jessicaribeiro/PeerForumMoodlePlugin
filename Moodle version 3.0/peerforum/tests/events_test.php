...
class mod_peerforum_events_testcase extends advanced_testcase {
    ...
    public function test_discussion_created() {
        ...
        $expected = array($course->id, 'peerforum', 'add discussion', "discuss.php?d={$discussion->id}", $discussion->id, $peerforum->cmid);
        $this->assertEventLegacyLogData($expected, $event);
        $this->assertEventContextNotUsed($event);
    ...
    public function test_discussion_deleted() {
        ...
        $this->assertEquals($context, $event->get_context());
        $expected = array($course->id, 'peerforum', 'delete discussion', "view.php?id={$peerforum->cmid}", $peerforum->id, $peerforum->cmid);
        $this->assertEventLegacyLogData($expected, $event);
        $this->assertEventContextNotUsed($event);
    ...
    public function test_course_module_viewed() {
        ...
        $this->assertEquals($context, $event->get_context());
        $expected = array($course->id, 'peerforum', 'view peerforum', "view.php?f={$peerforum->id}", $peerforum->id, $peerforum->cmid);
        $this->assertEventLegacyLogData($expected, $event);
    ...
    public function test_readtracking_enabled() {
        ...
        $this->assertEquals($context, $event->get_context());
        $expected = array($course->id, 'peerforum', 'start tracking', "view.php?f={$peerforum->id}", $peerforum->id, $peerforum->cmid);
        $this->assertEventLegacyLogData($expected, $event);
        $url = new \moodle_url('/mod/peerforum/view.php', array('f' => $peerforum->id));
        $this->assertEquals($url, $event->get_url());
        $this->assertEventContextNotUsed($event);
    ...
    public function test_readtracking_disabled() {
        ...
        $this->assertEquals($context, $event->get_context());
        $expected = array($course->id, 'peerforum', 'stop tracking', "view.php?f={$peerforum->id}", $peerforum->id, $peerforum->cmid);
        $this->assertEventLegacyLogData($expected, $event);
        $url = new \moodle_url('/mod/peerforum/view.php', array('f' => $peerforum->id));
        $this->assertEquals($url, $event->get_url());
        $this->assertEventContextNotUsed($event);
    ...
    public function test_subscribers_viewed() {
        ...
        $this->assertEquals($context, $event->get_context());
        $expected = array($course->id, 'peerforum', 'view subscribers', "subscribers.php?id={$peerforum->id}", $peerforum->id, $peerforum->cmid);
        $this->assertEventLegacyLogData($expected, $event);
        $this->assertEventContextNotUsed($event);
    ...
    public function test_post_created_postid_validation() {
        ...
        $params = array(
            'context' => context_module::instance($peerforum->cmid),
            'other' => array('peerforumid' => $peerforum->id, 'peerforumtype' => $peerforum->type, 'discussionid' => $discussion->id)
        );
    ...
    public function test_post_created_context_validation() {
        ...
        $params = array(
            'context' => context_system::instance(),
            'objectid' => $post->id,
            'other' => array('discussionid' => $discussion->id, 'peerforumid' => $peerforum->id, 'peerforumtype' => $peerforum->type)
        );
    ...
    public function test_post_deleted() {
        ...
        $expected = array($course->id, 'peerforum', 'delete post', "discuss.php?d={$discussion->id}", $lastpost->id, $peerforum->cmid);
        $this->assertEventLegacyLogData($expected, $event);
        $url = new \moodle_url('/mod/peerforum/discuss.php', array('d' => $discussion->id));
        $this->assertEquals($url, $event->get_url());
        $this->assertEventContextNotUsed($event);
        ...
        foreach ($events as $event) {
            ...
            $this->assertInstanceOf('\mod_peerforum\event\post_deleted', $event);
            $this->assertEquals(context_module::instance($peerforum->cmid), $event->get_context());
            $expected = array($course->id, 'peerforum', 'delete post', "discuss.php?d={$discussion->id}", $post->id, $peerforum->cmid);
            $this->assertEventLegacyLogData($expected, $event);
            $url = new \moodle_url('/mod/peerforum/discuss.php', array('d' => $discussion->id));
            $this->assertEquals($url, $event->get_url());
            $this->assertEventContextNotUsed($event);
