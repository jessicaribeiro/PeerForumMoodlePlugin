...
///////
    ...
    if($showincontext){
    $output .= html_writer::tag('div', 'PeerForum: '.$post->peerforumname, array('class'=>'title',
                                                           'role' => 'heading',
                                                           'aria-level' => '1',
                                                            'style' => 'color: #7F7F81'));
 ...
 * @param bool $canrate
 */
function peerforum_print_discussion($course, $cm, $peerforum, $discussion, $post, $mode, $canreply=NULL, $canrate=false, $cangrade=false, $showincontext=false, $to_peergrade_block=true, $url_block=null) {
