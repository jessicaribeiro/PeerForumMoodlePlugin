...
/// Print settings and things across the top
    ...
    switch ($peerforum->type) {
        case 'single':
            ...
            $cangrade    = has_capability('mod/peerforum:grade', $context);

            $cangrade     = false;
            $displaymode = get_user_preferences("peerforum_displaymode", $CFG->peerforum_displaymode);

            echo '&nbsp;'; // this should fix the floating in FF
            peerforum_print_discussion($course, $cm, $peerforum, $discussion, $post, $displaymode, $canreply, $canrate, $cangrade, true, false, true, null);
            break;
