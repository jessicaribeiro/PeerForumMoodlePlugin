...
$string['rolewarningpeer_help'] = 'To submit peer grades users require the mod/peerforum:peergrade capability and any module specific capabilities. Users assigned the following roles should be able to peergrade items. The list of roles may be amended via the permissions link in the administration block.';
...
$string['configblockoutliers'] = 'Set to \'No\' if you want to block/eliminate automatically red outliers from final grades (hide red grades on the Peer Grade panel on View Peergrades tab)';
$string['warningoutliers'] = 'Threshold for warnign outliers';
$string['configwarningoutliers'] = 'Configure the threshold value for warnign outliers (yellow grades on the Peer Grade panel on View Peergrades tab)';
...
$string['rolewarningrate_help'] = 'To submit ratings users require the mod/peerforum:ratepeer capability and any module specific capabilities. Users assigned the following roles should be able to rate items. The list of roles may be amended via the permissions link in the administration block.';
$string['scaleselectionrequiredrate'] = 'When selecting a ratings aggregate type you must also select to use either a scale or set a maximum points.';
...
$string['expirepeergrade_help'] = "Select 'yes' if you want the peer grade public anyway if after x days (defined above) not everyone has graded the post assigned to them.";
...
$string['showafterrating_help'] = "Select 'yes' if you want to show final peer grade only after rating ends (the ratings assessed type must be set to yes)";
...
$string['showafterpeergrade_help'] = "Select 'yes' if you want to show final rating only after peer grade ends (the peer grade assessed type must be set to yes)";
...
$string['showpostid_help'] = "Select 'yes' if you want the posts' id to be displayed in the Peer Forum. This can be usefull for the Peer Grade panel.";
...
$string['showdetails_help'] = "Select 'yes' if you want to show, in a PeerForum post, two select options about assigning and removing students to peer grade the post.";
