...
/*if(empty($peerforumid)){
    ...
    print_object('$peerforumid2 '.$peerforumid);
}*/
            ...
            for($i = 0; $i < count($userposts); $i++){
                ...
                if(!in_array($userposts[$i], $userposts_graded)){
                    ...
                    if(!empty($post)){
                        ...
                        peerforum_print_discussion($course, $cm, $peerforum, $discussion, $post, $displaymode, null, true, true, true, true, $PAGE->url);
                    }
                }
            }
        }
        ...
        if(!empty($userposts_graded)){
            for($i = 0; $i < count($userposts_graded); $i++){
                ...
                if(!empty($post_graded)){
                    ...
                    peerforum_print_discussion($course, $cm, $peerforum, $discussion, $post_graded, $displaymode, null, true, true, true, false, $PAGE->url);
                }
            }
        }
        if(empty($userposts_graded)){
        ...
        if(!empty($userposts_expired)){
            for($i = 0; $i < count($userposts_expired); $i++){
                ...
                if(!empty($post_expired)){
                    ...
                    peerforum_print_discussion($course, $cm, $peerforum, $discussion, $post_expired, $displaymode, null, true, true, true, false, $PAGE->url);
                }
            }
        }
        if(empty($userposts_graded)){
