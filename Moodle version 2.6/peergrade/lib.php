...
/*
public function verify_post_expired($postid, $peerforum, $peergrade, $userid, $courseid){
    global $DB, $PAGE;
...
public function time_to_see_feedbacks($peerforum, $userid, $postid, $grader){
    global $DB, $PAGE;
...
public function time_to_see_grades($peerforum, $userid, $postid, $grader){
    global $DB, $PAGE;
...
public function can_see_grades($peerforum, $userid, $postid, $grader){
    global $DB, $PAGE;
...
public function can_see_feedbacks($peerforum, $userid, $postid, $grader){
    global $DB, $PAGE;
