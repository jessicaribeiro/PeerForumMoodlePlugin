...
public function render_ratingpeer(ratingpeer $ratingpeer) {
    ...
    $ratingpeermanager->initialise_ratingpeer_javascript($this->page);
    ...
    if ($ratingpeer->user_can_ratepeer()) {
        ...
        $scaleattrs = array('class'=>'postratingmenu ratingpeerinput','id'=>'menuratingpeer'.$ratingpeer->itemid);
        $ratingpeerhtml .= html_writer::label($ratingpeer->ratingpeer, 'menurating'.$ratingpeer->itemid, false, array('class' => 'accesshide'));
