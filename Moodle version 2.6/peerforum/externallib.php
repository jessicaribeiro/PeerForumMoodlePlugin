...
class mod_peerforum_external extends external_api {
        ...
        return new external_multiple_structure(
            new external_single_structure(
                array(
                    ...
                    'peergradeassessed' => new external_value(PARAM_INT, 'Aggregate type'),
                    'assesstimestart' => new external_value(PARAM_INT, 'Assess start time'),
                    'peergradeassesstimestart' => new external_value(PARAM_INT, 'Assess start time'),
                    'assesstimefinish' => new external_value(PARAM_INT, 'Assess finish time'),
                    'peergradeassesstimefinish' => new external_value(PARAM_INT, 'Assess finish time'),
                    'scale' => new external_value(PARAM_INT, 'Scale'),
                    'peergradescale' => new external_value(PARAM_INT, 'PeergradeScale'),
                    'peergradesvisibility' => new external_value(PARAM_INT, 'Peer grade visibility'),
                    'peergradesvisibilitywhen' => new external_value(PARAM_INT, 'Peer grade visibility when'),
                    'feedbackvisibilitywhen' => new external_value(PARAM_INT, 'Feedback visibility when'),
                    'feedbackvisibility' => new external_value(PARAM_INT, 'Peer grade visibility'),
                    ...
                    'numdiscussions' => new external_value(PARAM_INT, 'Number of discussions in the peerforum', VALUE_OPTIONAL),
        ...
        foreach ($peerforumids as $id) {
            ...
            if ($discussions = $DB->get_records_select('peerforum_discussions', $select, $params, 'timemodified DESC', '*',
                ...
                foreach ($discussions as $discussion) {
                    ...
                    $return->peergradeassessed = $discussion->peergradeassessed;
        ...
        return new external_multiple_structure(
            new external_single_structure(
                array(
                    ...
                    'peergradeassessed' => new external_value(PARAM_INT, 'Is this peergrade assessed?'),
                    'timemodified' => new external_value(PARAM_INT, 'Time modified'),
    ...
    public static function get_peerforum_discussions_paginated($peerforumid, $sortby = 'timemodified', $sortdirection = 'DESC',
        ...
        $alldiscussions = peerforum_get_discussions($cm, $sort, true, -1, -1, true, $page, $perpage, PEERFORUM_POSTS_ALL_USER_GROUPS);
                        ...
                        foreach ($files as $file) {
                            ...
                            $discussion->attachments[] = array(
                                ...
                                'fileurl'  => file_encode_url($CFG->wwwroot.'/webservice/pluginfile.php',
                                                '/'.$modcontext->id.'/mod_peerforum/attachment/'.$discussion->id.'/'.$filename)
                            );
                        }
                    }
                }
