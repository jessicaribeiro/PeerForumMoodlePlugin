...
$string['peerforum:viewallratingpeers'] = 'View all raw ratingpeers given by individuals';
$string['peerforum:viewanyratingpeer'] = 'View total ratingpeers that anyone received';
...
$string['peerforum:viewratingpeer'] = 'View the total ratingpeer you received';
...
$string['rolewarningrate_help'] = 'To submit ratings users require the moodle/rating:rate capability and any module specific capabilities. Users assigned the following roles should be able to rate items. The list of roles may be amended via the permissions link in the administration block.';
