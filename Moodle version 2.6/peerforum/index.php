...
if (!is_null($subscribe)) {
    ...
    foreach ($modinfo->get_instances_of('peerforum') as $peerforumid=>$cm) {
        ...
        if (!peerforum_is_forcesubscribed($peerforum)) {
            ...
            if ((has_capability('moodle/course:manageactivities', $coursecontext, $USER->id) || $peerforum->forcesubscribe != PEERFORUM_DISALLOWSUBSCRIBE) && $subscribe && !$subscribed && $cansub) {
