...
if ($ADMIN->fulltree) {
    ...
    // display outliers
    $settings->add(new admin_setting_configselect('seeoutliers',
    ...
    $settings->add(new admin_setting_configselect('outlierdetection',
        get_string('outlierdetection', 'peerforum'), get_string('configoutlierdetection', 'peerforum'), 'standard deviation', $detection));


    $settings->add(new admin_setting_configtext('outdetectvalue', get_string('outdetectvalue', 'peerforum'),
