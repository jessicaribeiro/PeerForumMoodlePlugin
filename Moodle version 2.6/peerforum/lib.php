 ...
 *            rateduserid => int the id of the user whose items have been peergraded. NOT the user who submitted the peergrading. 0 to update all. [required]
...
function peerforum_update_grades($peerforum, $userid = 0, $nullifnone = true) {
        ...
        if (!empty($rategrades) && $peerforum->assessed) {
           peerforum_grade_item_update($peerforum, null, null, $rategrades);
             ...
             peerforum_grade_item_update($peerforum, $peergradesprofessors, $peergradesstudents, $rategrades);
...
/*Rate*/
            ...
            $item3['itemname'] = get_string('gradeitemrate', 'peerforum', $a);
            ...
            grade_update('mod/peerforum', $peerforum->course, 'mod', 'peerforum', $peerforum->id, 2, $rategrades, $item3);
    }
