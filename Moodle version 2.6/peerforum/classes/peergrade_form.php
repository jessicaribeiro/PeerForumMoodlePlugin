...
// Process the area fields only
        ...
        //Give feedback
        $mform->addElement('editor', 'message', get_string('givefeedback', 'peerforum'), null, self::editor_options($modcontext, (empty($post->id) ? null : $post->id)));
